...
-- Base inicial compatible con el proyecto actual
...
CREATE INDEX IF NOT EXISTS idx_colab_campana ON colaboraciones(campana_id);
CREATE INDEX IF NOT EXISTS idx_hitos_campana ON hitos_campana(campana_id);
CREATE INDEX IF NOT EXISTS idx_cal_eventos_fecha ON cal_eventos(fecha);
